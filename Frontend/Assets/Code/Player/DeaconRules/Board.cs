...
namespace Code.Player.DeaconRules
{
    public readonly struct Board
    {
        ...
        // private readonly NativeArray<byte> pieces;
        ...
        public Piece? this[int2 coordinate] => pieces[C(coordinate)];
        ...
        private static int C(int2 coordinate) => C(coordinate.x, coordinate.y);
    }
}
