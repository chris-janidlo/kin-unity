...
namespace UnityAtoms.LDJ50
{
    ...
    /// </summary>
    [AddComponentMenu(
        "Unity Atoms/Sync Variable Instancer to Collection/Sync ADecider Variable Instancer to Collection"
    )]
    [EditorIcon("atom-icon-delicate")]
    public class SyncADeciderVariableInstancerToCollection
