...
namespace UnityAtoms.LDJ50
{
    ...
    /// </summary>
    [Serializable]
    public sealed class ADeciderReference
        ...
        >,
            IEquatable<ADeciderReference>
    {
        public ADeciderReference()
            : base() { }

        public ADeciderReference(ADecider value)
            : base(value) { }

        public bool Equals(ADeciderReference other)
        {
