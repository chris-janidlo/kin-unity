...
namespace UnityAtoms.LDJ50
{
    ...
    [CreateAssetMenu(menuName = "Unity Atoms/Actions/Set Variable Value/ADecider", fileName = "SetADeciderVariableValue")]
    public sealed class SetADeciderVariableValue : SetVariableValue<
        ADecider,
        ADeciderPair,
        ADeciderVariable,
        ADeciderConstant,
