...
namespace Tests.Player.MCTS
{
    ...
    public class TestSearcher
    {
        ...
        public void SearchReturnsLegalMove()
        {
            ...
            var actionBuffer = new List<TestAction>(rootState.ActionArrayMaxSize);
            rootState.GetAvailableActions(actionBuffer);
            ...
            Assert.True(found, $"unable to find {move.Addend} in {rootState.Value}'s legal moves");
        }
